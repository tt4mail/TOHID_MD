...
const REPO_OWNER = '917849917350';
const REPO_NAME = 'TOHID_MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *TOHID_MD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*TOHID_MD PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://i.ibb.co/4ZSYvPTq/lordali.jpg` }, // Replace with your image URL
