...
cmd({
    ...
    try {
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://i.ibb.co/4ZSYvPTq/lordali.jpg'; // Remplacez par l'URL de votre image AI
...
cmd({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://i.ibb.co/4ZSYvPTq/lordali.jpg'; // Replace with a valid image URL
